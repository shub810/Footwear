...
.log input[type=submit]{
    ...
    <body>
       ...
       // session_start();
        ...
        <table class="t"><tr>
        <?php 
            $custom_id1 = $_GET['custom_id'];
            $id = $_GET['id'];
           // echo $id;
            $conn = mysqli_connect("localhost", "root", "", "footwear");
            $sql = "SELECT * FROM allbrands WHERE gender=$id";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                $_1 = $row['brandName'];
                $_2 = $row['images'];
                $_3 = $row['gender'];
                echo "<td><a href='brand.php?brand_name=$_1&url=$_2&custom_id=$custom_id1&gender=$_3'><img src=$_2 height='200' width='300'></img></a></td>";
            }
            echo "</tr>";
            echo "</table>";
            ?>
